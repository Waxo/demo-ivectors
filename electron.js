...
app.on('ready', function onReady() {
  ...
  // additional unforeseen and unpredictable issues.  Attempting to resume
  // normally after an uncaught exception can be similar to pulling out of the
  // power cord when upgrading a computer -- nine out of ten times nothing
  // happens - but the 10th time, the system becomes corrupted.  The correct
  // use of 'uncaughtException' is to perform synchronous cleanup of allocated
  // resources (e.g. file descriptors, handles, etc) before shutting down the
  // process.
